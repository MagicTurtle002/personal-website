...
export default function Projects() {
  ...
  const allCategories = ["All", ...new Set(projects.map(project => project.projectType))];
      ...
      <div className="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
        ...
        {filteredProjects.length > 2 && (
          ...
          >
            ...
            >
              <span>{showAllProjects ? "Show Less" : `Show More (${filteredProjects.length - 2})`}</span>
              <svg 
        ...
        >
          <div className="text-center">
            <h3 className={`text-4xl font-bold ${darkMode ? "text-indigo-400" : "text-indigo-600"}`}>
              <Counter end={projectStats.totalProjects} />+
            </h3>
            <p className={`mt-2 ${darkMode ? "text-gray-300" : "text-gray-600"}`}>Projects Completed</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className={`mt-2 ${darkMode ? "text-gray-300" : "text-gray-600"}`}>Technologies Used</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className={`mt-2 ${darkMode ? "text-gray-300" : "text-gray-600"}`}>On-Time Delivery</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className={`mt-2 ${darkMode ? "text-gray-300" : "text-gray-600"}`}>Client Satisfaction</p>
          </div>
        </motion.div>
            ...
            >
              <div className="flex items-center mb-4">
                <div className={`w-12 h-12 rounded-full flex items-center justify-center ${
                  ...
                  <span className={`text-xl font-bold ${darkMode ? "text-white" : "text-indigo-600"}`}>PA</span>
                </div>
                <div className="ml-4">
                  <h3 className={`font-medium ${darkMode ? "text-white" : "text-gray-900"}`}>Pet Adventure</h3>
                  <p className={`text-sm ${darkMode ? "text-gray-400" : "text-gray-500"}`}>Veterinary Clinic</p>
                </div>
              </div>
              <p className={`italic ${darkMode ? "text-gray-300" : "text-gray-600"}`}>
                "The Pawsitive system transformed our clinic operations. Record management is now seamless and our staff productivity has improved significantly."
              </p>
            </motion.div>
            ...
            >
              <div className="flex items-center mb-4">
                <div className={`w-12 h-12 rounded-full flex items-center justify-center ${
                  ...
                  <span className={`text-xl font-bold ${darkMode ? "text-white" : "text-indigo-600"}`}>HS</span>
                </div>
                <div className="ml-4">
                  <h3 className={`font-medium ${darkMode ? "text-white" : "text-gray-900"}`}>Highly Succeed Inc</h3>
                  <p className={`text-sm ${darkMode ? "text-gray-400" : "text-gray-500"}`}>Web Development</p>
                </div>
              </div>
              <p className={`italic ${darkMode ? "text-gray-300" : "text-gray-600"}`}>
                "Working with this developer was exceptional. The Unleash Web Portal exceeded our expectations and was delivered ahead of schedule."
              </p>
            </motion.div>
          </div>
        </motion.div>
