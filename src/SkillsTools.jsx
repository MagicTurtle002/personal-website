const posts = [
  {
    ...
    href: "#",
    description: "Experienced with React, Tailwind CSS, HTML5, CSS3, JavaScript, and Vite. I build clean, responsive, and interactive user interfaces.",
  ...
  },
  {
    ...
    href: "#",
    description: "Skilled in PHP, MySQL, and Node.js. I build secure and scalable APIs, work with databases, and manage server-side logic.",
  ...
  },
  {
    ...
    href: "#",
    description: "Comfortable using Git, GitHub, Figma, Postman, VS Code, and cloud platforms like Hostinger for deploying projects.",
    ...
    <div className="relative bg-white py-24 sm:py-32 overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Skills and Tools</h2>
          <p className="mt-2 text-lg leading-8 text-gray-600">
            A glimpse into the technologies I use to craft efficient and beautiful digital experiences.
          </p>
        </div>
