...
export const ProjectCard = ({ project, index, onOpenModal }) => {
    ...
    return (
        <div
            className="group relative overflow-hidden rounded-3xl bg-gradient-to-br from-white/90 via-slate-50/80 to-white/90 backdrop-blur-xl border border-slate-200/50 hover:border-blue-400/50 transition-all duration-700 transform hover:scale-[1.02] hover:-translate-y-2 shadow-lg hover:shadow-xl"
